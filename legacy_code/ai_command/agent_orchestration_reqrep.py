...
from agent_orchestration_base import AgentOrchestrationBase, OrchestrationPattern, AgentMessage
from zmq_node_base import ProcessorInterface, ProcessingRequest, ProcessorType
...
class ReqRepOrchestrator(AgentOrchestrationBase):
    ...
    async def spawn_child_agent(self, child_id: str, role: str, processors: List[ProcessorInterface] = None) -> bool:
        ...
        try:
            ...
            from agent_orchestration_base import AgentOrchestrationBase
