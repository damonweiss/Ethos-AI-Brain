...
# TODO: Update paths when Brain structure stabilizes
...
# Temporary: Focus on conventional tools without reasoning dependencies
try:
    from ...mcp_tools.mcp_tool_manager import MCPToolManager
    from ...mcp_tools.namespace_registry import namespace_registry, parse_namespaced_tool_name
    TOOLS_AVAILABLE = True
except ImportError:
    print("Warning: Tool discovery not available, running in basic mode")
    MCPToolManager = None
...
class UnifiedMCPServer:
    ...
    def __init__(self):
        # Shared meta-reasoner instance (commented out for conventional tools focus)
        self.meta_reasoner = None
        self.flask_app = None
        self.flask_thread = None
        # TODO: Re-enable when Brain structure stabilizes
